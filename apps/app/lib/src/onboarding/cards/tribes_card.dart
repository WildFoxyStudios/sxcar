...
class TribesCard extends StatefulWidget {
  const TribesCard({
    super.key,
    required this.card,
...
class _TribesCardState extends State<TribesCard> {
  bool _busy = false;
  String? _error;
  ...
  Future<void> _submit() async {
    ...
    try {
      await widget.provider.completeCard('tribes', {
        'tribes': _selected.toList(),
      });
